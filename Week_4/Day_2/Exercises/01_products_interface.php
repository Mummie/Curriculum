  ...
  <body>
    ...
    <?php
        ...
        class Product implements Describable {
          ...
          public function __construct($name,$price,$brand,$description){
            $this->name = $name;
            $this->price = $price;
            $this->brand = $brand;
        ...
        $hawaiian = new Product("Hawaiian T Shirt", 23.99, "Hang 10", "Shirt with flowers");
        echo $hawaiian->provideDescription();
